...
import com.algoboss.core.util.report.PDFExporter;
import com.algoboss.core.util.report.PDFExporter2;
...
public class AdmAlgoappBean extends GenericBean<DevEntityObject> implements Cloneable{
	...
	public AdmAlgoappBean() {
		super.url = "views/app/administration/algodev/algodevView.xhtml";
