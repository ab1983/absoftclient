...
/*
	...
	public Object saveImpl(Object obj) throws Throwable {
		...
		try {
			...
			obj = toManaged(obj);
			boolean isNew = !entityManager.contains(obj);
			if (isNew) {
				// userTransaction.begin();
				...
				/*
				Object objActual = ctx.getBusinessObject(BaseDao.class).refresh(obj);
				if(objActual!= null){
					obj = objActual;
				}*/
				// userTransaction.commit();
	...
	public Object toManaged(Object obj) throws Throwable {
		Throwable t = null;
		...
		try {
			if (obj != null) {
				...
				if(!managed){
					Object obj2 = findByObj(obj,true);
					if(obj2 != null){
						copyObject(obj, obj2);
						obj = obj2;
					}
	...
	@TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public List<AdmInstantiatesSite> findByContractId(Long contractId){
